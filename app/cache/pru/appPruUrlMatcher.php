 ...
 */
class appPruUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    /**
     * Constructor.
     */
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/alimentos')) {
            ...
            if (rtrim($pathinfo, '/') === '/alimentos') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'VAMAB_homepage');
                }

                return array (  '_controller' => 'VDG\\AulasMentor\\AlimentosBundle\\Controller\\DefaultController::indexAction',  '_route' => 'VAMAB_homepage',);
            }

            // VAMAB_listar
            if ($pathinfo === '/alimentos/listar') {
                return array (  '_controller' => 'VDG\\AulasMentor\\AlimentosBundle\\Controller\\DefaultController::listarAction',  '_route' => 'VAMAB_listar',);
            }
            ...
            if (0 === strpos($pathinfo, '/alimentos/ver') && preg_match('#^/alimentos/ver/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'VAMAB_ver')), array (  '_controller' => 'VDG\\AulasMentor\\AlimentosBundle\\Controller\\DefaultController::verAction',));
            }
